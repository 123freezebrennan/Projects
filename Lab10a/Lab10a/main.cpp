...
int main() {
    ...
    cout << "*** Lab 8 tests on original array a: "
        << (RunPart1Tests(a) ? "passed" : "failed") << endl;

    cout << "*** Lab 8 tests on array created with copy constructor: "
    ...
    b.append(1000); // add a new element to b
    ...
    // ...and print
    cout << "Testing final output:" << endl;
